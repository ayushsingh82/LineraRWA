      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl border border-primary/20 p-12 md:p-16 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of investors building wealth through tokenized real estate. Start with as little as $100.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="px-8 py-3 rounded-lg border border-primary text-primary font-semibold hover:bg-primary/5 transition">
              Schedule Demo
            </button>
          </div>
        </div>
